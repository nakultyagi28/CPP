...
SECRET_KEY = 'django-insecure-gyic2^tlx%-&+lh@6+nku(9a_wsp6uyl$9wrq2etg*g3kkbt%1'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    "cpppythonenv.eba-v49kx67j.us-east-1.elasticbeanstalk.com"
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [f"{BASE_DIR}/learning/templates"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
